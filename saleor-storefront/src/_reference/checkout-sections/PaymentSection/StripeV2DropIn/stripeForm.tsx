...
export function CheckoutForm() {
	...
	return (
		<form className="my-8 flex flex-col gap-y-6" onSubmit={handleSubmit}>
			...
			<button
				className="h-12 items-center rounded-md bg-neutral-900 px-6 py-3 text-base font-medium leading-6 text-white shadow-sm hover:bg-neutral-800 disabled:cursor-not-allowed disabled:opacity-70 hover:disabled:bg-neutral-700 aria-disabled:cursor-not-allowed aria-disabled:opacity-70 hover:aria-disabled:bg-neutral-700"
...
function Loader() {
	return (
		<div className="text-center" aria-busy="true" role="status">
			{/* Wrap SVG in div for GPU-accelerated animation */}
			<div className="mr-2 inline-block h-6 w-6 animate-spin">
				<svg
					aria-hidden="true"
					className="h-full w-full fill-neutral-600 text-neutral-100 dark:text-neutral-600"
					viewBox="0 0 100 101"
					fill="none"
